...
Marionette.View = Backbone.View.extend({
  ...
  configureTriggers: function( existingEvents ){
    ...
    triggers = this.expandUIBindingsInEventOrTrigggersHash(triggers);
    ...
    _.each(triggers, function(value, key){
      ...
      // on this events, as specified by the events hash, then just add the trigger
      // function to the triggerEvents hash (which will later be merged with the
      // original events hash). But if there is already a function there, then
  ...
  delegateEvents: function(events){
    ...
    events = this.expandUIBindingsInEventOrTrigggersHash(events);
  ...
  // in the events hash.
  expandUIBindingsInEventOrTrigggersHash : function(events) {
    var newEvents = {};
